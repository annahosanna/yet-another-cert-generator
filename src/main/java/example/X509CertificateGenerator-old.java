...
public class X509CertificateGenerator {
   ...
   */
  private static DistributionPoint[] getCRLDisributionPoints(
   ...
   * Helper to parse a colon separated list of CRL distribution points.
   */
  private static void addCRLDisributionPointExtension(
   ...
   */
  public static String buildX500PrincipleString(
    String country,
    String state,
    String location,
    String organization,
   ...
   */
  public static IssuerAndSerialNumber getIssuerAndSerialNumber(
   ...
   */
  public static X509Certificate createV1RootCA(
    PublicKey pubKey,
    PrivateKey privKey,
    long serialNumber,
    int durationInDays,
   ...
   */
  public static X509Certificate createV3RootCA(
    PublicKey pubKey,
    PrivateKey privKey,
    long serialNumber,
    int durationInDays,
    ...
    certBuilder.addExtension(
      ...
      false,
      extUtils.createAuthorityKeyIdentifier(certHolder)
    );
  ...
  public static X509Certificate createIntermediateCA(
    ...
    SubjectPublicKeyInfo subjectKeyId =
      SubjectPublicKeyInfoFactory.createSubjectPublicKeyInfo(pubKey);
    ...
    certBuilder.addExtension(
      X509Extension.subjectKeyIdentifier,
      false,
      extUtils.createSubjectKeyIdentifier(subjectKeyId)
    );
    certBuilder.addExtension(
      X509Extension.authorityKeyIdentifier,
      false,
      extUtils.createAuthorityKeyIdentifier(holder)
    );
    addCRLDisributionPointExtension(certBuilder, crlDistributionPoints);

    // Signing
    AlgorithmIdentifier sigAlg = new DefaultSignatureAlgorithmIdentifierFinder()
      .find("SHA1withRSA");
    AlgorithmIdentifier digAlg = new DefaultDigestAlgorithmIdentifierFinder()
      .find(sigAlg);
    ContentSigner certSigner = new BcRSAContentSignerBuilder(
      sigAlg,
      digAlg
    ).build(caPrivKey);
    X509CertificateHolder certHolder = certBuilder.build(certSigner);
  ...
  public static void savePKCS12(
    ...
    throws NoSuchAlgorithmException, CertificateException, IOException, KeyStoreException, NoSuchProviderException, InvalidKeyException {
